...
define('lg_admin_emailtemplates_publicex', 'This is the default public note template. It can be overridden on a per mailbox basis. See individual boxes on the <br /><a href="'.action('Admin\AdminBaseController@adminFileCalled', ['pg' => 'admin.mailboxes']).'">mailbox screen</a>');
